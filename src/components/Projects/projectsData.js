export const projects = [
  {
    ...
    tags: ['Python','data analytics','sql lite', 'OpenCV', 'ML','llm','Api-groq'],
  ...
  },
  {
    ...
    category: 'Dashboards',
    tags: ['Power BI','DAX','SQL','Python','Power Query','Data Modeling','Data Visualization','Business Intelligence'],
    desc: 'Developed an end-to-end Business Intelligence and Analytics Dashboard for a fictional KFC franchise network using Power BI, Python, SQL, DAX, and Power Query',
    fullDesc: 'Developed an end-to-end Business Intelligence and Analytics Dashboard for a fictional KFC franchise network using Power BI, Python, SQL, DAX, and Power Query. The project addresses the challenge of fragmented restaurant data by integrating 100,000+ customer orders, 350,000+ transaction records, 15,000+ customers, 200+ products, and 25 franchise branches into a centralized executive dashboard. The solution provides real-time KPI monitoring, sales and profit analysis, customer segmentation, branch performance, product profitability, payment analysis, sales forecasting, and AI-driven business recommendations. The analytics reveal insights such as weekend sales contributing approximately 35–40% more revenue than weekdays, top-selling products generating nearly 60% of total revenue, the top 20% of customers contributing around 50% of sales, and the highest-performing branches delivering over 30% greater profit than the network average. The interactive dashboard enables data-driven decision-making through dynamic filters, forecasting, and performance monitoring while demonstrating expertise in data modeling, DAX, dashboard development, and business intelligence',
    tech: ['Power BI', 'DAX', 'Excel', 'SQL'],
    gradient: 'linear-gradient(135deg, #533483, #e94560)',
    icon: 'project images loading please wait😊',
    folder: 'bank-loan',
    github: 'https://github.com/vigneshwaran22ad23/KFC-Smart-Business-Intelligence-AI-Analytics-Platform',
  },
  {
    id: 3,
  ...
  {
    id: 7,
    title: 'EV Adoption Forecasting Platform',
    category: 'Data Analytics with ml model prediction',
    tags: ['Python', 'Scikit-learn', 'Pandas', 'NumPy', 'Streamlit', 'Matplotlib', 'Machine Learning', 'Time-Series Forecasting', 'Predictive Analytics', 'Data Cleaning', 'Feature Engineering', 'Data Visualization', 'Model Evaluation', 'Joblib', 'Git'],
    desc: 'An interactive Power BI dashboard analyzing employee attrition, performance, and workforce demographics to support data-driven HR decisions.',
    fullDesc: 'Developed an AI-powered EV Adoption Forecasting Platform to address the challenge of accurately predicting future electric vehicle adoption using historical registration data. Built an end-to-end machine learning solution that cleans and preprocesses data, performs feature engineering, and generates county-wise EV adoption forecasts for the next 36 months through an interactive Streamlit dashboard. The platform provides historical trend analysis, growth projections, and comparative visualizations, reducing manual forecasting effort by approximately 80% while enabling faster, data-driven infrastructure planning and investment decisions. Leveraged Python, Pandas, NumPy, Scikit-learn, Streamlit, Matplotlib, Machine Learning, Predictive Analytics, Feature Engineering, and Data Visualization to deliver scalable and actionable forecasting insights[😊Note: In this project live demo not avilable]',
    tech: ['Python', 'Scikit-learn', 'Pandas', 'NumPy', 'Streamlit', 'Matplotlib', 'Machine Learning', 'Time-Series Forecasting', 'Predictive Analytics', 'Data Cleaning', 'Feature Engineering', 'Data Visualization', 'Model Evaluation', 'Joblib', 'Git'],
    gradient: 'linear-gradient(135deg, #0f3460, #533483)',
    icon: 'project images loading please wait😊',
    folder: 'EV Adoption Forecasting Platform',
    github: 'https://github.com/vigneshwaran22ad23/E-Commerce-Business-Intelligence-Platform',
  },
